package com.dabin.library_common.config;
...
{
    /** 基础库 */
    private static final String BaseInit = "com.dabin.library_common.CommonModuleInit";
    
    /** main组件库 */
    private static final String MainInit =
        "com.dabin.module_main.application.MainModuleInit";
