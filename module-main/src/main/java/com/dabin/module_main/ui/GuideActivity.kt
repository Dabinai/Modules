...
import com.dabin.module_main.viewholder.CustomPageViewHolder
...
class GuideActivity : BaseDataActivity(), HolderCreator<CustomPageViewHolder> {
    ...
    private val data : List<CustomBean> get(){
        val list = ArrayList<CustomBean>()
        for (i in  mDrawList.indices){
            var customBean = CustomBean()
            customBean.imageRes = mDrawList[i]
    ...
    private fun setupViewPager() {
        ...
        mViewPager.setAutoPlay(false)
            ...
            .setIndicatorColor(
                ContextCompat.getColor(this, R.color.main_white),
