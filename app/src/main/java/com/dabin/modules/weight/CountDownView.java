package com.dabin.modules.weight;
...
public class CountDownView extends View {
    ...
    private void init() {
        ...
        mPaintAcr = new Paint();
        mPaintAcr.setStyle(Paint.Style.STROKE);
        mPaintAcr.setAntiAlias(true);
        mPaintAcr.setColor(mPaintArcColor);
        mPaintAcr.setStrokeWidth(mPaintArcWidth);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(rectF, startAngle, mSweepAngle, false, mPaintAcr);
    ...
    public void setLoadingFinishListener(OnLoadingFinishListener loadingFinishListener) {
